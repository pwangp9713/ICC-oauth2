...
//    MybatisMapper mm;
    ...
    public JSONObject getToken(@RequestParam String code, HttpServletRequest request) {
        ...
        params.add("redirect_uri", "http://localhost:7000/givemetoken");
        HttpEntity<MultiValueMap<String, String>> requestEntity = new HttpEntity<>(params, headers);
        ResponseEntity<String> response = restTemplate.postForEntity("http://localhost:7000/oauth/token", requestEntity, String.class);
