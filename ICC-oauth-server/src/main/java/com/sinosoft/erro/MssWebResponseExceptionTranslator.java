...
//        }
        Exception ase = (InvalidGrantException) throwableAnalyzer.getFirstThrowableOfType(InvalidGrantException.class,
                causeChain);
        if (ase != null) {
            return handleOAuth2Exception(new MssWebResponseExceptionTranslator.InvalidGrant(e.getMessage(), e));
        }
    ...
    @SuppressWarnings("serial")
    private static class InvalidGrant extends OAuth2Exception {

        public InvalidGrant(String msg, Throwable t) {
            super("aaaaaaa", t);
        }

        @Override
        public String getOAuth2ErrorCode() {
            return "invalid_grant2222";
        }
...
//            return "{\"error\":\"invalid_grant111\",\"error_description\":\"Bad credentials\"}";
//        }
    }
}
